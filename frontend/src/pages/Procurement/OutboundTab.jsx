...
export default function OutboundTab() {
  ...
  const exportXLSX = () => {
    ...
    const body = articles.map(a => [
      ...
      a.item_name,
      a.variant || '',
      a.total_required_qty,
      ...pos.map(p => a.quantities[p.po_id] || 0),
    ]);
        ...
        <div className="overflow-auto max-h-[70vh]">
          <table className="text-sm border-separate border-spacing-0">
            <thead>
              ...
              <tr className="bg-gray-50">
                <th className={`${stickyNameHead} px-4 py-3 text-left font-semibold text-gray-600 border-b border-r border-gray-200 w-56`}>Article</th>
            ...
            <tbody>
              {loading ? (
                ...
                <tr key={a.packaging_raw_material_id} className="hover:bg-gray-50">
                  ...
                  {pos.map(p => {
                    const q = a.quantities[p.po_id] || 0;
                    return (
